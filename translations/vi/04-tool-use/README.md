...
Như chúng ta đã học trong [Bài học 2](../02-explore-agentic-frameworks/README.md), các khung agentic cung cấp các khối xây dựng sẵn để triển khai việc sử dụng công cụ.
